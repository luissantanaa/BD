...
Public Class Form1
    ...
    Private Sub bttnEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles bttnEdit.Click
        currentContact = ListBox1.SelectedIndex
        Console.WriteLine(currentContact.ToString())
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        '' Change this line...
        CN = New SqlConnection("data source=DESKTOP-B76RDHJ\SQLEXPRESS;integrated security=true;initial catalog=Northwind")
